...
public class ContentFragment extends BaseFragment implements AlbumView, AlbumGriView, SelectedPhoto {
    View mView;
    ...
    public void initDatas() {
        super.initDatas();
        mImageScannerPresenter = new ImageScannerPresenterImpl(ContentFragment.this);
    ...
    public View initViews() {
        ...
        //gridView.setSelectedPhoto(ContentFragment.this);
        recycleView.setSelectedPhoto(ContentFragment.this);
        //gridView.setOnItemClickListener(ContentFragment.this);
        //gridView.setOnItemLongClickListener(ContentFragment.this);
        albumGridPresenter = new AlbumGridPresenter(ContentFragment.this);
