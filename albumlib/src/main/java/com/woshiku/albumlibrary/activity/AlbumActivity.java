...
import com.woshiku.albumlibrary.fragment.impleBase.ContentFragment;
import com.woshiku.albumlibrary.fragment.impleBase.LeftFragment;
...
public class AlbumActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initFragment(FragmentActivity context){
        leftFragment = new LeftFragment(context);
        contentFragment = new ContentFragment(context);
        FragmentManager fm = getSupportFragmentManager();
        FragmentTransaction trans = fm.beginTransaction();
        trans.replace(R.id.frame_left, leftFragment, Left_Menu);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.all_pics_bt) {
            ...
            leftFragment.showData(albumFoldInfo);
            leftFragment.jumpOrHide();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        {
            if(leftFragment.getLineVisible() == View.VISIBLE){
                leftFragment.hide();
                return true;
            }else{
                finish();
