...
window.onload = function(){
    ...
    listMyFamily(_healthMessage_token);
     needToken()
    */
    /*listMyFamily('U3ofEFQdTZdfWRF1suUu2ESZa//WMMJtNLXemgMbWMA2g5RA6HOJQg__');*/
    listMyFamily(needToken());
};

function needToken(){
    var str = window.control.getMyParam();
    return str;
}
